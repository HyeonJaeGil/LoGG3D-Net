...
eval_arg.add_argument('--eval_task', type=str, default='inter', choices=['intra', 'inter'])
eval_arg.add_argument('--eval_seq', type=str,
                      default='Riverside04/Ouster')
eval_arg.add_argument('--eval_seq_q', type=str, nargs='+', default=['Town03/Ouster'])
...
eval_arg.add_argument("--revisit_criteria", default=7.5,
